...
export const NavBar = () => {
  ...
  return (
    <div className="fixed min-h-full shadow-xl p-2 bg-white" id="scrollBar">
      <div className="flex items-center gap-2 p-4 justify-center border-b-2 z-10">
        <svg
        ...
        <h1 className="font-extrabold text-2xl">JMI</h1>
      </div>
      ...
      <div className="mx-5 p-3">
        <div>
          ...
          <div className="flex items-center gap-2 my-5 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
            ...
            <Link to="/index" className="font-bold">
              Home
            </Link>
          </div>
        </div>
        ...
        <div className="flex items-end gap-2 mt-6 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
          ...
          <Link to="/viewBill" className="font-bold">
            Billing Record
          </Link>
        </div>
        <div>
          <h1 className="text-violet-600 mt-5 font-bold text-2xl">Expense</h1>
          <div className="flex items-between gap-2 mt-4 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
            ...
            <Link to="/addExpense" className="font-bold">
              Add Expense
            </Link>
          </div>
        </div>
        <div className="flex items-between gap-2 mt-6 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <Link to="/expenseRecord" className="font-bold">
            Expense Record
          </Link>
        </div>
        ...
        <div>
          ...
          <div className="flex items-between gap-2 mt-5 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
            ...
            <Link to="/profit" className="font-bold">
              Net Profit
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-between gap-2 mt-5 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
            ...
            <Link to="/addInventory" className="font-bold">
              Add Inventory
            </Link>
          </div>
          <div className="flex items-between gap-2 mt-5 p-2 hover:bg-violet-500 hover:rounded-md hover:text-white">
            ...
            <Link to="/viewInventory" className="font-bold">
              Inventory Record
            </Link>
          </div>
        </div>
        ...
        <div>
          <hr className="mt-5" style={{ backgroundColor: '#8b5cf6', border: 'none', height: 2 }}></hr>
          <div className="flex items-between gap-2 mt-5 p-2 bg-violet-500 text-white hover:bg-white rounded-md hover:rounded-md hover:text-black">
            <svg style={{ height: 28 }} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <button className="font-bold" onClick={onClickLogout}>
              Log Out
            </button>
          </div>
