...
import { userGetArchiveList } from "../modules/service-archiveList";
...
const ArchiveList = () => {
    ...
    },
    {
        ...
        render: (text , record) => {
          return (
           <button className="bg-green-500 p-2 rounded-md" onClick={() => handleRestore(record._id)}>
            Restore
           </button>
          )
        },
    ...
    return(
       ...
       <h5 className="font-bold text-xl">Archive List</h5>
       </div>
       </div>
       <Row>
          <Col xl={24}>
